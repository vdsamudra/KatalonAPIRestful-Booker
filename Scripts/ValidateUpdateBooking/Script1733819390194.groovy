...
GlobalVariable.firstname = ('newfirstname' + new Random().nextInt(1000))

GlobalVariable.lastname = ('newlastname' + new Random().nextInt(1000))

response = WS.sendRequest(findTestObject('UpdateBooking'))
